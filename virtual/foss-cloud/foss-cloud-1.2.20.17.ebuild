...
RDEPEND="cifs? ( net-fs/cifs-utils )
	...
	~net-nds/sst-ldap-schemas-1.2.21
	~sys-apps/fc-node-integration-1.2.22
	~sys-apps/fc-prov-backup-kvm-1.0.11
	~x11-themes/fc-artwork-1.0.4
	~www-apps/vm-manager-1.2.26.16
	~sys-apps/fc-configuration-1.2.16
	~sys-kernel/foss-cloud-bin-3.11.10
	~app-emulation/fc-broker-daemon-1.2.13
"
