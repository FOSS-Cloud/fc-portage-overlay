...
RDEPEND="cifs? ( net-fs/cifs-utils )
	...
	sys-block/nbd
	~app-misc/fc-misc-scripts-1.2.1
	~net-nds/sst-ldap-schemas-1.2.2
	~sys-apps/fc-node-integration-1.2.4
	~sys-apps/fc-prov-backup-kvm-1.0.6
	~x11-themes/fc-artwork-1.0.4
	~www-apps/vm-manager-1.2.5
	~sys-apps/fc-configuration-1.2.2
	~sys-kernel/foss-cloud-bin-3.6.8
	~app-emulation/fc-broker-daemon-1.2.5
"
