...
RDEPEND="cifs? ( net-fs/cifs-utils )
	...
	~net-nds/sst-ldap-schemas-1.2.0
	~sys-apps/fc-node-integration-1.2.1
	~sys-apps/fc-prov-backup-kvm-1.0.1
	~x11-themes/fc-artwork-1.0.4
	~www-apps/vm-manager-1.2.0
	~sys-apps/fc-configuration-1.2.0
	~sys-kernel/foss-cloud-bin-3.6.8
	~app-emulation/fc-broker-daemon-1.2.1
"
