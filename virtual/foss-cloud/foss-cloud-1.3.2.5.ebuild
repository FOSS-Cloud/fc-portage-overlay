...
RDEPEND="cifs? ( net-fs/cifs-utils )
	...
	~app-misc/fc-misc-scripts-1.3.2
    ~net-nds/fc-ldap-schemas-1.3.2
	~net-nds/fc-ldap-utils-1.3.2
	~sys-apps/fc-node-integration-1.3.2
	~sys-apps/fc-prov-backup-kvm-1.0.11
	~x11-themes/fc-artwork-1.0.4
	~www-apps/vm-manager-1.3.2.1
	~sys-apps/fc-configuration-overlay-1.3.2
    ~sys-apps/fc-syslog-ng-configuration-1.3.2
    ~sys-kernel/foss-cloud-bin-4.10.1
	~app-emulation/fc-broker-daemon-1.3.2.1
"
