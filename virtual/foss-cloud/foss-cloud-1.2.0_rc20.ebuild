...
RDEPEND="cifs? ( net-fs/cifs-utils )
	...
	~sys-apps/fc-node-integration-1.2.12
	~sys-apps/fc-prov-backup-kvm-1.0.7
	~x11-themes/fc-artwork-1.0.4
	~www-apps/vm-manager-1.2.12
	~sys-apps/fc-configuration-1.2.10
	~sys-kernel/foss-cloud-bin-3.8.0
	~app-emulation/fc-broker-daemon-1.2.8
"
