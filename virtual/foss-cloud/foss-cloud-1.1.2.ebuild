...
RDEPEND="cifs? ( net-fs/cifs-utils )
	...
	sys-block/nbd
	~app-misc/fc-misc-scripts-1.1.0
	~net-nds/sst-ldap-schemas-1.1.1
	~sys-apps/fc-node-integration-1.1.2
	~sys-apps/fc-prov-backup-kvm-0.9.2
	~x11-themes/fc-artwork-1.0.4
	~www-apps/vm-manager-1.1.2
	~sys-apps/fc-configuration-1.1.2
